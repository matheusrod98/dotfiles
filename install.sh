...
sudo dnf remove -y gnome-music gnome-calculator gnome-characters cheese evince gnome-logs gnome-screenshot gnome-weather gnome-clocks eog gnome-font-viewer gedit libreoffice-core

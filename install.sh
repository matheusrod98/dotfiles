...
sudo dnf install neovim git-lfs stow clang gcc nodejs npm ripgrep fd-find lazygit code docker docker-compose wl-clipboard tmux alacritty zsh trash-cli
git-lfs install

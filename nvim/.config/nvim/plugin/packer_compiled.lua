...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
